...
public enum MiddleItem {
    ...
    MEGA_BAT(ItemUtils.getItemStack(Material.IRON_SWORD, "Mega bat", 1, "§f§bHITS HARD", Enchantment.KNOCKBACK, 10, Enchantment.FIRE_ASPECT, 5)),
    EXPLOSION_GUN(ItemUtils.getItemStack(Material.GOLD_HOE, "Epic gun", 1, "§6Right click pointing at a block to send someone in the air !"));
